...
export default function AboutUs() {
  return (
    <section className="bg-[#f7f1f0] py-20 px-6 flex justify-center font-[biondi]">
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-[#2f1316] text-3xl md:text-5xl font-light tracking-wider font-[biondi]">
            Redefining Real Estate in Dubai
          </h1>
        </div>

        {/* Story */}
        <div className="space-y-6 text-[#2f1316] font-light leading-relaxed mb-16">
          <p>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-[#a97a67] text-xl font-[note] mb-4">Our Mission</h2>
            <p className="text-[#2f1316] font-light leading-relaxed">
          ...
          <div>
            <h2 className="text-[#a97a67] text-xl font-[note] mb-4">Our Vision</h2>
            <p className="text-[#2f1316] font-light leading-relaxed">
        ...
        {/* Who We Serve */}
        <div className="mt-20">
          <h2 className="text-[#2f1316] text-2xl md:text-3xl font-[biondi] mb-8">
            Who We Serve
          </h2>
          <ul className="grid md:grid-cols-2 gap-6 text-[#2f1316] font-light leading-relaxed">
            <li>
